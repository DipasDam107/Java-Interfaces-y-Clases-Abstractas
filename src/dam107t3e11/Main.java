/*
 Añade el sufijo _v2 a las clases de ej. 2.5: movilPrepago, movilTarifaPlana, movilPlus crea una
interfaz que estas clases implementarían. Genera métodos y, si es necesario, métodos por defecto.
 */
package dam107t3e11;
